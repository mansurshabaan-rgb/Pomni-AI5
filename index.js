...
const client = new Client({
  phoneNumber: '201557346292', // Bot number
  prefix: [".", "/", "!"],
  fromMe: true, 
  owners: [
  // Owner 1
    { name: "𝕸𝖚𝖘𝖙𝖆𝖋𝖆", lid: "201557346292@lid", jid: "201557346292@s.whatsapp.net" },
  // Owner 2
    { name: "𝕸𝖚𝖘𝖙𝖆𝖋𝖆", lid: "201208197039@lid", jid: "201208197039@s.whatsapp.net" },
  // Owner 3
